...
form.addEventListener('submit', function(event) {
  ...
  stripe.createPaymentMethod({
    ...
    window.location.href = 'https://cisswork.com/Android/SenderApp/API/stripe-payment/attechPatmentmethodToCustomer.php?paymentMethodId=' + paymentMethodId + '&customerId=' + customerId + '&cardNumber=' + cardNumber + '&expMonth=' + expMonth + '&expYear=' + expYear+ '&PaymentDetails=' + PaymentDetails;
  }).catch(function(error) {
    // Handle errors
    console.error(error);
    // Hide spinner
    document.getElementById('spinner').classList.add('hidden');
    document.getElementById('button-text').innerText = 'Add Card';
