...
$trm=mysqli_query($con,"SELECT * FROM `tbl_terms_condition` WHERE type='Admin'");
...
<div class="container" style="padding: 0 10px 0 10px;">
    <div>
  <!--<center><h1>Dropus Terms & Condition</h1></center>  -->
  <div>

<div>
    <?php 
    while($row=mysqli_fetch_assoc($trm))
    {  ?>
    
   <h1 style="text-align: justify;"><?php echo $row['terms_condition'];?></h1>
 <?php } ?>
