            ...
            <div class="box-body">
                   <div class="row">
                       <div class="col-md-12">
                        ...
                        <?php
                        //                 $srt1=mysqli_query($con,"select * from tbl_user_privacy WHERE type='Admin' ");
                        //                 $srtt1=mysqli_fetch_assoc($srt1);
                                      ...
                                      <div class="form-group">
                                        <textarea type="text" class="form-control" id="addressInput" oninput="clearErrorMessage()" name="privacy_policy" required></textarea>
        ...
        USER PRIVACY POLICY LIST
                        ...
                        <div class="table-responsive">
                             <table id="example2" class="table table-bordered table-striped ">
                                  ...
                                  <tbody>
                                        <?php
                        $sqls=mysqli_query($con,"SELECT * FROM tbl_user_privacy WHERE type='Admin' ORDER BY term_id DESC");
                        $count=0;
                ...
                <button class=" dropdown-toggle" type="button" data-toggle="dropdown" style="border: none;background: #fff0;"><img src="dist/img/setting.png" style="width:30px;height:30px;">
                        ...
                        <ul class="dropdown-menu">
                          <li><a href="edit_user_privacypolicy.php?id=<?php echo $row['term_id']?>" data-toggle="tooltip" title="Edit"><img src="dist/img/edit.png" style="width:30px;height:30px;"></a></li>
                          ...
                          <!--<li><a href="#" data-toggle="tooltip" title="inactive"><img src="dist/img/inactive.png" style="width:30px;height:30px;"></a></li>-->
                           <li><a href="add_user_privacypolicy.php?fdid=<?php echo $row['term_id']?>" data-toggle="tooltip" title="Delete"><img src="dist/img/delete.png" style="width:30px;height:30px;"></a></li>
                        </ul>
                      </div></td>
                 </tr>
                <?php } ?>
...
<?php
        ...
        {
            $fdid=$_GET['fdid'];
            $del=mysqli_query($con,"delete from tbl_user_privacy where term_id='$fdid'");
            if($del)
            {
