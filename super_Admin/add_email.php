  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
          <div style="padding: 0 27px 0 27px;"> <!-----div main---->
                            ...
                            ?>
                              ...
                              <div class="box-body">
                               ...
                               <div class="form-group">
                                ...
                                <!--<div class="form-group">-->
                                <!--    <label class="control-label" for="name">Support Contact</label>-->
                                <!--     <input  type="tel" id="phone" name="con"   class="form-control" placeholder=" Please Enter Phone Number" required>-->
                ...
                //   }else if (emailParts[0].indexOf('@') !== emailParts[1].lastIndexOf('@')) {
                //   // Check if there are multiple '@' symbols
                //   errorText.textContent = 'Multiple "@" symbols are not allowed';
                //   }
                // // } else if (/[^a-z0-9._%+-@]/.test(emailParts[0])) {
                // //   // Check for special characters before '@' (excluding '+')
                // //   errorText.textContent = 'Special characters (excluding "+") are not allowed before "@"';
                // // } 
