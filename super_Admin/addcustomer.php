          ...
          <div style="padding: 0 27px 0 27px;"> <!-----div main---->
                <div class="row">
                       ...
                       if(isset($_POST['add']) && !empty($_POST['add']))
                        {
                           ...
                           $contact=$_POST['contact'];
                            $em=$_POST['email'];
                           $password=$_POST['pass'];
                           $select=mysqli_query($con,"SELECT * FROM user_register WHERE email='$em'");
                           $row_select=mysqli_fetch_assoc($select);
                           $selects=mysqli_query($con,"SELECT * FROM user_register WHERE contact='$contact' AND country_code='$cod'");
                           $row_selects=mysqli_fetch_assoc($selects);
                           $phone_num=$row_selects['contact']; $pcode=$row_selects['country_code'];
                       $ueml=$row_select['email'];
                    //   if($phone_num==$contact && $pcode==$cod)
                    //     {
                    ...
                    //       else   {
                           ...
                           $insert=mysqli_query($con,"INSERT INTO `user_register`(`full_name`, `email`, `password`, `country_code`, `contact`, `wrok`, `image`, `device_id`, `iosdevice_id`, `device_status`, `address`, `lat`, `long`, `status`, `date`, `user_wallet`, `user_status`, `access_token`, `booking_cancel_time`, `type`, `google_token`, `facebook_token`,`apple_token`, `created_at`, `updated_at`, `secret_key`,`firebase_id`,`invite_code`,`id_proof_image`, `id_expiry_date`)
                           VALUES('$firstname','$em','$password','$cod','$contact','','$fname','','','','','','','','','','Approve','','$date','','','','','$date','','','','','$finame1','$expiry_date')");
                           ...
                           if($insert)
                            {
                                ...
                                $end_date = $rr['end_date'];
                                 ...
                                 $contac=str_replace("+","",$cod);
                                 $randomid = mt_rand(100000,999999);
                                 $secret_key=$insert_id.''.$randomid.''.$contac.''.$contact;
                                 
                                 $nme=substr($firstname, 0, 1);
                                 $random = mt_rand(10,99);
                                 $code=$nme.''.$insert_id.''.$random;
                                 $inv=$code;
                                 $updt=mysqli_query($con,"update user_register set secret_key='$secret_key',generated_code='$inv',code_start_date='$start_date',code_end_date='$end_date',customerID='$customerId'  where id='$insert_id'");
                                $perr="The User is added successfully!";
                                $to_email = $em;
                                $subject = 'Welcome to Cerber';
                                $txt ="Hello $firstname"."\r\n"; 
                                $txt.="Welcome to Cerber. Thank you for registering with us."."\r\n";
                                ...
                                //     echo "Email not sent. Error: $errorMessage";
                                // } else {
                ...
                <div class="box-body">
                    ...
                    <div class="form-group" col-md-6>
                      <div class="form-group">
                        ...
                        <input type="text" name="name" id="textInput" onblur="clearTextField()" class="form-control required" placeholder=" Name" required>
                    ...
                    <div id="kilError" style="color: red;"></div>
                        <!--<input type="email" name="email" class="form-control required" autoComplete="new-password"  pattern="[a-zA-Z0-9.-_]{1,}@[a-zA-Z.-]{2,}[.]{1}[a-zA-Z]{2,}" placeholder=" Email" required>-->
                    </div>
                    <div class="form-group">
                    ...
                    <!--    <input type="text" name="work" class="form-control required" placeholder="business profile" required>-->
                    <!--</div>-->
                     ...
                     <div class="form-group row" style="margin-bottom: 0px;">
                        ...
                        <!--    <textarea name="Address" class="form-control required" placeholder=" Name" required> </textarea>-->
                        <!--</div>-->
                         <div class="form-group row" style="margin-bottom: 0px;">
                        <div class="form-group col-md-6">
            ...
            <div class="box-footer">
                <input type="submit" name="add" class="btn btn-primary" value="Submit"/>
                 <!--<button class="btn btn-danger" onclick="window.location.href = 'viewcustomer.php';">Cancel</button>-->
