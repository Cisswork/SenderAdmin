                ...
                <div class="row">
                    <div class="box box-primary">
                        ...
                        //       else   {
                            ...
                            //   $insert=mysqli_query($con,"INSERT INTO `user_register`(`full_name`, `email`, `password`, `country_code`, `contact`, `wrok`, `image`, `device_id`, `iosdevice_id`, `device_status`, `address`, `lat`, `long`, `status`, `date`, `user_wallet`, `user_status`, `access_token`, `booking_cancel_time`, `type`, `google_token`, `facebook_token`,`apple_token`, `created_at`, `updated_at`, `secret_key`,`firebase_id`,`invite_code`,`id_proof_image`, `id_expiry_date`,customerID)
                            //   VALUES('$firstname','$em','$password','$cod','$contact','','$fname','','','','','','','','','','Approve','','$date','','','','','$date','','','','','$finame1','$expiry_date','$customerId')");
