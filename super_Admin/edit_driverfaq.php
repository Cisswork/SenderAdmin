...
<?php   include('header.php');    ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
        <a href="driver_faq.php"><button type="button" class="btn btn-info" style="float: right;margin: 13px;">BACK TO LISTING</button></a>
      <h1>
        DRIVER EDIT FAQ
      </h1>
                ...
                <div class="row">
                          ...
                          <div class="box box-primary">
                            <div class="box-header with-border">
                              <h3 class="box-title">DRIVER EDIT FAQ</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            <?php
                                       ...
                                       if(isset($_GET['id']))
                                        {
                                            $id=$_GET['id'];
                                         $que=mysqli_query($con,"select * from driver_faq where df_id='$id'");
                                         ...
                                         if(isset($_POST['add']) && !empty($_POST['add']))
                                         {
                                           ...
                                           $insert=mysqli_query($con,"UPDATE `driver_faq` SET `ques`='$info3',`answer`='$info31' WHERE df_id='$id'");
                      ...
                      <div class="form-group">
                        ...
                        <!--<input type="text" name="ques" class="form-control" placeholder="Enter question" value="<?php echo $ques['ques'];?>">-->
                    </div>
                    <div class="form-group">
                        ...
                        <!--<input type="text" name="answer" class="form-control" placeholder="Enter answer" value="<?php echo $ques['answer'];?>">-->
                    </div>
