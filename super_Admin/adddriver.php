                             ...
                             <?php
                                    ...
                                    if(isset($_POST['submit']))
                                    {
                                       ...
                                       // $route_id_list = $_REQUEST['route_id_list'];
                                        ...
                                        // $sql="SELECT * FROM car_names_tbl WHERE id='$car_id'";
                                        ...
                                        if($row>0)
                                        {
                                            $perr="A record with the given Contact Number already exist, Enter another unique Contact Number and try again";
                                            echo "<script type='text/javascript'>alert(\"$perr\");</script>";
                                        }
                                        elseif($row1>0)
                                        {
                                            $perr="A record with the given Email ID already exist, Enter another unique Email ID and try again";
                                            echo "<script type='text/javascript'>alert(\"$perr\");</script>";
                                        }
                                        else
                                        {
                                            ...
                                            VALUES ('$UserName','$Password','$FirstName','$LastName','$Address','$Address2','$City','$State','$Zip','$lat','$lng','$Email','$country_code','$Phone','$Phone2','$Phone3','','0','','','','$LicenseNum','$finame2','$finame','','','','0','0','$date','','','','','$route_id_list','','$flag')");
                                            ...
                                            {
                                                $perr="Driver added successfully!";
                                                $to_email = $Email;
                ...
                ?>
                 <form role="form" method="post" id="emailForm" class="validate" autocomplete="off"  enctype="multipart/form-data" id="myform">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="UserName" class="form-control required" placeholder="User Name" required>
                            </div>
                        </div>
                         <div class="col-md-6">
                            <div class="form-group">
                         ...
                         <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="LastName" class="form-control required" placeholder="Last Name" required>
                            </div>
                        </div>
                    </div>
                     <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="email" name="Email" class="form-control required"  autoComplete="new-password"id="emailInput" onkeyup="validateEmail()"  onblur="clearEmailField()" placeholder=" Email" required>
                            <div id="errorText" style="color: red;"></div>
                        </div>
                        <div class="form-group col-md-6">
                            <label class="control-label" for="name">Password</label>
                            <input type="password" name="Password" class="form-control required"  autoComplete="new-password" placeholder=" Password" required id="passwordInput" onkeyup="validatePassword()" onblur="clearPassword()">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="form-group">
                            <input  type="text" id="phone" name="country_code"  onkeyup="validateCode()"  onblur="clearCode()"  class="form-control" placeholder=" Please Enter Phone Number" style="margin-right: -149px;" required>
                        </div>
                        <div class="form-group"> 
                           <input  type="number" name="Phone"  id="contactInput" onkeyup="validateContactNumber()" onblur="clearContactNumber()"  class="form-control" placeholder="Phone Number" style="margin-top: -49px;margin-left: 105px;width: 183px;" required>
                        </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="form-group">
                            <input  type="text" id="phone2" name="country_code"  onkeyup="validateCode()"  onblur="clearCode()"  class="form-control" placeholder=" Please Enter Phone Number" style="margin-right: -149px;" required>
                        </div>
                        <div class="form-group"> 
                           <input  type="number" name="Phone2"  id="contactInput" onkeyup="validateContactNumber()" onblur="clearContactNumber()"  class="form-control" placeholder="Phone Number" style="margin-top: -49px;margin-left: 105px;width: 183px;" required>
                        </div>
                        <div id="errorText3" style="color: red;"></div>
                        <div id="errorText1" style="color: red;"></div> 
                    </div>
                    <div class="form-group col-md-4">
                        ...
                        <div class="form-group">
                            <input  type="text" id="phone3" name="country_code"  onkeyup="validateCode()"  onblur="clearCode()"  class="form-control" placeholder=" Please Enter Phone Number" style="margin-right: -149px;" required>
                        </div>
                        <div class="form-group"> 
                          <input  type="number" name="Phone3"  id="contactInput" onkeyup="validateContactNumber()" onblur="clearContactNumber()"  class="form-control" placeholder="Phone Number" style="margin-top: -49px;margin-left: 105px;width: 183px;" required>
                        </div>
                        <div id="errorText3" style="color: red;"></div>
                        <div id="errorText1" style="color: red;"></div>  
                    </div>
                    <div class="form-group">
                        ...
                        <textarea name="Address" class="form-control required"required placeholder="Address" ></textarea>
                    </div>
                     <div class="form-group">
                        <label class="control-label" for="name">Address2</label>
                        <textarea name="Address2" class="form-control required"required placeholder="Address2" ></textarea>
                    </div>
                     <div class="form-group">
                        <label class="control-label" for="name">City</label>
                        <textarea name="City" class="form-control required"required placeholder="City" ></textarea>
                    </div>
                     <div class="form-group">
                        <label class="control-label" for="name">State</label>
                        <textarea name="State" class="form-control required"required placeholder="State" ></textarea>
                    </div>
                     <div class="form-group">
                        <label class="control-label" for="name">Zip</label>
                        <input type="number" name="Zip" class="form-control required" placeholder="Zip">
                    </div>
                    <!--<div class="form-group">-->
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="file"  name="image" onchange="return validateImage1()" id="image" class="required"class size="20" style="width: 230px;position: relative;" required />
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="file"  name="license_image" onchange="return validateImage1()" id="image1" class="required"class size="20" style="width: 230px;position: relative;" required />
                            <!--<div id="image_req" style="color: red"></div>-->
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0"  name="LicenseNum"  class="form-control required" placeholder="LicenseNum" required> 
