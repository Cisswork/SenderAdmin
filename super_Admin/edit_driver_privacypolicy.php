...
<head>
  ...
  <title>Add Company Privacy Policy</title>
                       ...
                       <div class="col-md-12">
                          ...
                          <?php
                                       if(isset($_GET['id']))
                                        {
                                            $id=$_GET['id'];
                                            $srt1=mysqli_query($con,"select * from tbl_driver_privacy WHERE type='Admin' AND pid='$id'");
                                         ...
                                         if(isset($_POST['submit']) && !empty($_POST['submit']))
                                         {
                                            ...
                                            $srt=mysqli_query($con,"select * from tbl_driver_privacy WHERE type='Admin' AND pid='$id'");
                                            $srtt=mysqli_fetch_assoc($srt);
                                            $num=mysqli_num_rows($srt);
                                            if($num>0)
                                            {
                                                $upd=mysqli_query($con,"update tbl_driver_privacy set privacy_policy='$terms_condition' WHERE type='Admin' AND pid='$id'");
                                                if($upd)
                                                {
                                       ...
                                       <form role="form" method="post"  enctype="multipart/form-data" >
                                        <div class="form-group">
                                            <label class="control-label" for="name">Add Company Privacy Policy</label>
                                              <textarea type="text" class="form-control" id="myeditor"   name="terms_condition" required><?php echo $srtt1['privacy_policy'];?></textarea>
