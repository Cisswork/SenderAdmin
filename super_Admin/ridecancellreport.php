...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <tbody>
    <?php
        $sql="SELECT * FROM `notification_tbl` where driver_status='cancel' order by id desc ";
        ...
        //   if($status=='cancel' && $row['cancel_by']=='User')
        //     {
        //         $cancel_sql=mysqli_query($con,"SELECT * FROM canclebooking WHERE booking_id='$id'");
        //         $cancel_fetch=mysqli_fetch_assoc($cancel_sql); 
        //         $cancel_reason=$cancel_fetch['cancel_reason'];
        //     }
        //     elseif($status=='cancel' && $row['cancel_by']=='Driver')
        //     {
        //         $cancel_sql1=mysqli_query($con,"SELECT * FROM canclebooking_driver WHERE booking_id='$id'");
        //         $cancel_fetch1=mysqli_fetch_assoc($cancel_sql1); 
        //         $cancel_reason1=$cancel_fetch1['reason'];
        //     }
    ?>  
    <tr>
        ...
        <td class="center"><?php echo date('d-m-Y',strtotime($dd)).' '.date('h:i A',strtotime($tt));?></td>
